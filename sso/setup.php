...
require_once 'connector.php';?>
        <div class="row">
            <div class="col-md-12">
              ...
              <td width="20%">Enter metadataaa URL:</td>
              <td><input type="url" name="metadata_url" ' . Mo_Saml_License_Utility::is_customer_license_valid( true ) . ' placeholder="Enter metadata URL of your IdP." style="width:100%" value="' . $sync_url . '"/></td>
              <td width="20%">&nbsp;&nbsp;<input type="submit" ' . Mo_Saml_License_Utility::is_customer_license_valid( true ) . ' class="button button-primary button-large" value="Fetch Metadata"/></td>
			</tr></form></div></div>
              <div class="row">
              <div class="col-lg-6">
                <form method="POST" action="" id="saml_form">
